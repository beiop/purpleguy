...
class CmdWorld():
    ...
    def removeEntities(self,entity_type_id=-1):
...
class CmdEntity(CmdPositioner):
    ...
    def spawnItem(self,*args):
        ...
        for some reason, entity.getPos() format must be unpacked (*pos) to be used"""
        oldArgs = args
        args = list(args)
...
class Minecraft:
    ...
    def getBlockWithData(self, *args):
        """Get block (x,y,z) => id:int"""
        output = self.conn.sendReceive(b"world.getBlockWithData", intFloor(args))
